...
\[\mathcal P\{\id{state}_\id{prec}(e_1)\}\ \Rightarrow\ \mathcal P\{\id{state}_\id{prec}(e_2)\}\]
\label{def:Consistency}
\end{definition}

	The third property is isolation.
	A transaction $\id{act}_\id{prec}(e_1,e_2)$ is isolated, i.e. performed in isolation, if it does not affect any other transaction in the system.
