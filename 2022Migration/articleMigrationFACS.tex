...
%   If $R$ is a set of relations that covers those that occur in the rule, then changes to an information system $\infsys$ can be described by the event $\infsys \xrightarrow[\{r\}]{R} \infsys'$.
