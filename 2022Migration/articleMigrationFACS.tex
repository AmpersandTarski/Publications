...
\subsection{General migration script}\label{General migration script}
   This section presents a general approach for generating a migration script.
   Let $\overleftarrow{\infsys}$ be the existing system, and let $\overrightarrow{\infsys}$ be the desired system.
   Consequently, we define $\pair{\overleftarrow{\dataset}}{\overleftarrow{\schema}}=\overleftarrow{\infsys}$ and $\pair{\overrightarrow{\dataset}}{\overrightarrow{\schema}}=\overrightarrow{\infsys}$ as the data set and schema of the existing and desired system, respectively.
   We also define $\quadruple{\overleftarrow{\concepts}}{\overleftarrow{\rels}}{\overleftarrow{\rules}}{\overleftarrow{\transactions}}=\overleftarrow{\schema}$
   and $\quadruple{\overrightarrow{\concepts}}{\overrightarrow{\rels}}{\overrightarrow{\rules}}{\overrightarrow{\transactions}}=\overrightarrow{\schema}$.

   Then we define the migration schema $\schema_\migrsys$ as follows:
