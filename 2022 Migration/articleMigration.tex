...
\begin{definition}[relabel relations in triples]
   \[\subst{\declare{m}{C}{D}}{m'}{\triple{a}{r}{b}} = \triple{a}{\subst{\declare{m}{C}{D}}{m'}{r}}{b}\]
\end{definition}
\begin{definition}[relabel relations in datasets]
   \[\begin{array}{rcl}
      \rlap{$\subst{\declare{m}{C}{D}}{m'}{\pair{\triples}{\inst}}$}\\
      &=&\pair{\{\subst{\declare{m}{C}{D}}{m'}{t}\mid t\in\triples\}}{\inst}
   \end{array}\]
\end{definition}
\begin{definition}[relabel relations in rules]
   \[\sat{u}{\dataset}\ \Leftrightarrow\ \sat{\subst{\declare{m}{C}{D}}{m'}{u}}{\subst{\declare{m}{C}{D}}{m'}{\dataset}}\]
\end{definition}
\begin{definition}[relabel relations in schemas]
   \begin{eqnarray}
      \rlap{$\subst{\declare{m}{C}{D}}{m'}{\triple{\concepts}{\rels}{\rules}}$}\notag\\
      &=&\la\concepts,\{\subst{\declare{m}{C}{D}}{m'}{r} \mid r\in\rels\}, \{\subst{\declare{m}{C}{D}}{m'}{u} \mid u\in\rules\}\ \ra\notag
   \end{eqnarray}
\end{definition}
