...
\end{equation}
   ...
   @Bas, In het onderstaande heb ik mij er nog wat te makkelijk vanaf gemaakt.
   Aandacht nodig.
      ...
      We denote events as $\ins{\pair{\triples_{\id{ev}}}{\inst_{\id{ev}}}}$ and $\del{\pair{\triples_{\id{ev}}}{\inst_{\id{ev}}}}$.
      They are defined by:
   \begin{eqnarray}
      \ins{\pair{\triples_{\id{ev}}}{\inst_{\id{ev}}}}(\dataset)&=&\pair{\triples_{\dataset}\cup\triples_{\id{ev}}}{\inst_{\dataset}\cup\inst_{\id{ev}}}\\
      \del{\pair{\triples_{\id{ev}}}{\inst_{\id{ev}}}}(\dataset)&=&\pair{\triples_{\dataset}-\triples_{\id{ev}}}{\inst_{\dataset}-\inst_{\id{ev}}}
   \end{eqnarray}
