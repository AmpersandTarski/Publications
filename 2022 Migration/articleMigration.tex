...
\footnote{In the sequel, the word ``system'' refers to the phrase ``information system''. This simplifies the language a little. }
   ...
   the users experience a system that evolves organically without them even noticing the updates.
   ...
   continually developed further in small incrementals.
...
\section{Analysis}
   ...
   In contrast with~\cite{Spivak2012}, however, our approach does not work with functions (functors)
...
\footnote{Allegories are a specific type of categories, which the reader does not need to understand for the purpose of this paper}~\cite{Zielinski2013}.
   ...
   The compiler builds systems that keep these constraints satisfied at all times.
...
\end{itemize}
   ...
   This requires a third schema, which specifies the migration itself.
   ...
   Hence, the migration is based on the disjoint union of the old and the new schemas.
   We generate the schema of the migration system in the form of source code,
