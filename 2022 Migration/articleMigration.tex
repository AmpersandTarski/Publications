...
\begin{equation}
   \pop{r}{\dataset}\ =\ \{ \pair{a}{b}\mid\ \triple{a}{r}{b}\in\triples\}
\end{equation}
...
\label{sct:Information Systems}
   ...
   This section introduces the notion of information system as a quadrtuple $\la\dataset_{\infsys},\schema_{\infsys},\roles_{\infsys},\maintain_{\infsys}\ra$.
