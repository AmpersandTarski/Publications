...
\end{eqnarray}
   ...
   When the expression is losing pairs that are in $r$, the engine will spontaneously remove such pairs from $r$ to keep $r$ smaller than or equal to \id{expression}.
   ...
   When the expression is growing with pairs that are in $r$, the engine will spontaneously insert such pairs in $r$ to keep $r$ greater than or equal to \id{expression}.
