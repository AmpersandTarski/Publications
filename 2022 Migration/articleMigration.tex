...
\label{sct:Datasets}
   ...
   This makes $\inst$ a total relation:
\begin{eqnarray}
...
\end{equation}
   ...
   \end{array}\]
   Requirement~\ref{eqn:concepts} is satisfied because every atom has a concept.
   Dataset $\pair{\triples}{\inst}$ satisfies both requirements~\ref{eqn:type} and~\ref{eqn:pop}.
   So, the dataset $\dataset=\pair{\triples}{\inst}$ satisfies the requirements from section~\ref{sct:Datasets}
   ...
   For the purpose of this paper, the functionality $\functionality$ is irrelevant (onderbouwen!).
   ...
   So, there are no violations, which satisfies requirement~\ref{eqn:typed violations}.
   ...
   This completes the requirements for the entire quintuple $\la\dataset,\schema,\functionality,\roles,\maintain\ra$.
