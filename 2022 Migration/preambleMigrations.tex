...
\newcommand{\maintain}{\id{maintain}}
\newcommand{\popC}{\id{popC}}
\newcommand{\popR}{\id{popR}}
\newcommand{\popT}[1]{\id{popT}(#1)}
\newcommand{\popH}[1]{\id{popH}(#1)}
\newcommand{\relname}[1]{\id{relname}(#1)}
\newcommand{\src}[1]{\id{src}(#1)}
\newcommand{\tgt}[1]{\id{tgt}(#1)}
\newcommand{\viol}[2]{\id{viol}_{#2}(#1)}
\newcommand{\signat}[1]{\id{signat}(#1)}
